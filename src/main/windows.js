...
function createUpdaterWindow() {
    ...
    updaterWindow = new BrowserWindow({
        width: 620, height: 470, frame: false, transparent: false, backgroundColor: '#000000', alwaysOnTop: true, skipTaskbar: true,
        resizable: false,
...
function createOnboardingWindow() {
    onboardingWindow = new BrowserWindow({
        width: 600, height: 560, frame: false, transparent: false, backgroundColor: '#000000', alwaysOnTop: true, skipTaskbar: true,
        resizable: false,
        webPreferences: { nodeIntegration: true, contextIsolation: false }
    });
...
function createMainWindow() {
    ...
    win = new BrowserWindow({
        ...
        title: "BurnedWolf · whyscripts.com",
        frame: false,
    ...
    tray.setToolTip("BurnedWolf · whyscripts.com");
...
function attemptExit() {
    ...
    exitWindow = new BrowserWindow({
        width: 430, height: 260, frame: false, transparent: false, backgroundColor: '#000000', alwaysOnTop: true, parent: win, modal: true, resizable: false,
        webPreferences: { nodeIntegration: true, contextIsolation: false }
    });
